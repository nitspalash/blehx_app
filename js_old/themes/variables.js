...
export default {
  ...
  // Color
  brandPrimary: platform === "ios" ? "#007aff" : "#112D42",
  brandInfo: "#62B1F6",
  brandSuccess: "#5cb85c",
  brandDanger: "#d9534f",
  brandWarning: "#f0ad4e",
  ...
  // Tab
  tabDefaultBg: platform === "ios" ? "#F8F8F8" : "#112D42",
  ...
  toolbarDefaultBg: platform === "ios" ? "#F8F8F8" : "#112D42",
  ...
  toolbarDefaultBorder: platform === "ios" ? "#a7a6ab" : "#112D42",
  get statusBarColor() {
